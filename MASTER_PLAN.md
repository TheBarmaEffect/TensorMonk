...
| 503 tests (unit + integration) | ✅ | 22 test files (pytest) |
...
| test_graph.py | 39 | Graph topology, strip_authorship, conditional edges, multi-factor confidence gate, domain thresholds, quality-gap spawning, adaptive temp, calibration, constitutional compliance, Platt scaling wiring |
